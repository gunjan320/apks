...
training_set = train_datagen.flow_from_directory('E:/pplant/Dataset/train', # relative path from working directoy
                                                 target_size = (128, 128),
                                                 batch_size = 19, class_mode = 'categorical')
valid_set = test_datagen.flow_from_directory('E:/pplant/Dataset/val', # relative path from working directoy
                                             target_size = (128, 128),
                                        batch_size = 19, class_mode = 'categorical')
